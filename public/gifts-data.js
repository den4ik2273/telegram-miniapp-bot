...
const products = [
    ...
    { id: 16, name: 'Tama Gadget', price: 3300, icon: '🎮', image: 'Подарки/TamaGadget-3300.png', description: 'Collectible #2014', specs: { Model: 'Tama Gadget 6%', Backdrop: 'Retro 9%', Symbol: 'Pixel 1.5%' } },
    { id: 17, name: 'Ginger Cookie', price: 3450, icon: '🍪', image: 'Подарки/GingerCookie-3450.png', description: 'Collectible #2015', specs: { Model: 'Ginger Cookie 5%', Backdrop: 'Spice 9%', Symbol: 'Candy 1.5%' } },
    { id: 18, name: 'Pet Snake', price: 4000, icon: '🐍', image: 'Подарки/PetSnake-4000.png', description: 'Collectible #2016', specs: { Model: 'Pet Snake 5%', Backdrop: 'Exotic 8%', Symbol: 'Scale 1.5%' } },
    { id: 19, name: 'Ginger Cookie', price: 4300, icon: '🍪', image: 'Подарки/GingerCookie-4300.png', description: 'Collectible #2017', specs: { Model: 'Ginger Cookie 5%', Backdrop: 'Delicious 8%', Symbol: 'Icing 1.5%' } },
    { id: 20, name: 'Top Hat', price: 4300, icon: '🎩', image: 'Подарки/TopHat-4300.png', description: 'Collectible #2018', specs: { Model: 'Top Hat 5%', Backdrop: 'Classic 8%', Symbol: 'Gentleman 1.5%' } },
    { id: 21, name: 'Xmas Stocking', price: 4600, icon: '🎄', image: 'Подарки/XmasStocking-4600.png', description: 'Collectible #2019', specs: { Model: 'Xmas Stocking 4%', Backdrop: 'Red 7%', Symbol: 'Ornament 1.5%' } },
    { id: 22, name: 'Winter Wreath', price: 5600, icon: '🎀', image: 'Подарки/WinterWreath-5600.png', description: 'Collectible #2020', specs: { Model: 'Winter Wreath 4%', Backdrop: 'Frost 7%', Symbol: 'Holly 1.5%' } },
    { id: 23, name: 'Input Key', price: 6000, icon: '🔑', image: 'Подарки/InputKey-6000.png', description: 'Collectible #2021', specs: { Model: 'Input Key 3%', Backdrop: 'Diamond 6%', Symbol: 'Unlock 1.5%' } },
    { id: 24, name: 'Ginger Cookie', price: 7200, icon: '🍪', image: 'Подарки/GingerCookie-7200.png', description: 'Collectible #2022', specs: { Model: 'Ginger Cookie 3%', Backdrop: 'Premium 6%', Symbol: 'Glaze 1.5%' } },
    { id: 25, name: 'Ginger Cookie', price: 7250, icon: '🍪', image: 'Подарки/GingerCookie-7250.png', description: 'Collectible #2023', specs: { Model: 'Ginger Cookie 3%', Backdrop: 'Special 6%', Symbol: 'Decor 1.5%' } },
    { id: 26, name: 'Voodoo Doll', price: 7460, icon: '🪆', image: 'Подарки/VoodooDoll-7460.png', description: 'Collectible #2024', specs: { Model: 'Voodoo Doll 3%', Backdrop: 'Dark 5%', Symbol: 'Mystery 1.5%' } },
    { id: 27, name: 'Bow Tie', price: 8000, icon: '🎀', image: 'Подарки/BowTie-8000.png', description: 'Collectible #2025', specs: { Model: 'Bow Tie 2%', Backdrop: 'Royal 5%', Symbol: 'Noble 1.5%' } },
